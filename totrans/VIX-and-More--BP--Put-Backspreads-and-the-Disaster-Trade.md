<!--yml
category: 未分类
date: 2024-05-18 17:07:42
-->

# VIX and More: BP, Put Backspreads and the Disaster Trade

> 来源：[http://vixandmore.blogspot.com/2010/06/bp-put-backspreads-and-disaster-trade.html#0001-01-01](http://vixandmore.blogspot.com/2010/06/bp-put-backspreads-and-disaster-trade.html#0001-01-01)

One of the more interesting trading setups is something I call the [disaster trade](http://vixandmore.blogspot.com/search/label/disaster%20trade). This type of trade typically sets up after a stock experiences a crushing blow, crashes once or twice and has shorts swirling all around it betting that the company will either fail or become permanently crippled.

This is exactly the type of situation [BP](http://vixandmore.blogspot.com/search/label/BP) is currently experiencing.

One different sort of way to use options to try to capitalize on the BP situation with limited risk is through the use of a [put backspread](http://vixandmore.blogspot.com/search/label/put%20backspread) or a [call backspread](http://vixandmore.blogspot.com/search/label/call%20backspread). A put backspread involves selling a smaller quantity of puts at a higher strike and buying a larger amount of puts at a lower strike. Depending upon market factors, this trade can be either a credit or a debit. In the first graphic below, the trade costs $25 to enter (before commissions.)
...
I have included the second graphic to show how optionsXpress uses a [lognormal distribution](http://en.wikipedia.org/wiki/Log-normal_distribution) to translate existing options data into an expected probability distribution at the time the July options expire. This helps to visualize the strategy and reinforces the fact that the put backspread is a fat tail disaster play.
