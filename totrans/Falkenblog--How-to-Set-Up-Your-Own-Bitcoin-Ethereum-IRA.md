<!--yml
category: 未分类
date: 2024-05-12 20:00:19
-->

# Falkenblog: How to Set Up Your Own Bitcoin/Ethereum IRA

> 来源：[http://falkenblog.blogspot.com/2017/08/how-to-set-up-your-own-bitcoinethereum.html#0001-01-01](http://falkenblog.blogspot.com/2017/08/how-to-set-up-your-own-bitcoinethereum.html#0001-01-01)

**Update**

: This is all out of date as of Jan 24 2018\. Check out

[this link](https://www.consumeraffairs.com/finance/bitcoin-ira/)

for a review of several crypto IRA providers.
...
, an IRA custodian based in Kentucky.  Rollover your IRA/401k there, informing them you plan to hold ETH or BTC in your IRA.

2) Set up an account at

[Genesis](https://genesistrading.com/)

 (not Gemini). You will need a clear picture of your driver's license you can email them, and a digital photo of a recent utility bill (w/in 3 months).

3) Once approved at Genesis, you to open a

[BitGo](https://www.bitgo.com/login)

account, as this exchange stores your initial wallet after the Genesis trade.
...
6) You then immediately fill out the Kingdom Trust "Investment Directive" form, which includes wire instructions to send your IRA money to Genesis's bank account at Silvergate Bank (see

[here](https://www.silvergatebank.com/services-tools/tools/wire-instructions.html)

), and your trade terms from Genesis, which includes how many ETHs were bought and for what USD price. You will need to sign the Kingdom Trust Investment Directive digitally, so add the PDF plug-in that allows digital signatures. Do this early in the morning, as even then it takes a day for them to instantiate the wire.
