<!--yml
category: 未分类
date: 2024-05-12 19:18:33
-->

# Quantitative Trading: Finding seasonal spreads

> 来源：[http://epchan.blogspot.com/2009/02/finding-seasonal-spreads_18.html#0001-01-01](http://epchan.blogspot.com/2009/02/finding-seasonal-spreads_18.html#0001-01-01)
...
is a spread which follows a regular pattern from year to year, such as generally falling in the Spring or generally rising in October. To find seasonal spreads, I've been using
...
. ANOVA is a well-established statistical technique which, given several groups of data, will determine if the groups have different averages. Importantly, it determines if the differences are
...
[on-line paper](http://quanttrader.info/public/findingSeasonalSpreads.html)

regarding ANOVA and seasonal spreads.
