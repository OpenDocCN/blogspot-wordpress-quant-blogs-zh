...
I think its a common issue. You have a vague problem. Experts all mention that if you repeat their prescription, in the long run, the problem will be solved. In the long run, 'this too shall pass', and so everything will be fixed by time, in that you will either die, or the problem will go away on its own accord, but their ministrations are not part of that solution. And then, when going for the solution, you need to do it

[balls to the wall](http://www.urbandictionary.com/define.php?term=balls+to+the+wall)

, not piecemeal. Piecemeal is when you are dealing with something very powerful. Modern drugs are basically created so that a 110 lb person who's allergic to everything won't have a bad reaction and sue you. Thus standard dosages are useless, though its kind of scary to take 3 times the recommended dose.
