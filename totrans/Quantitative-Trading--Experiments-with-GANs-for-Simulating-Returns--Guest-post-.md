...
# Quantitative Trading: Experiments with GANs for Simulating Returns (Guest post)

> 来源：[http://epchan.blogspot.com/2019/12/experiments-with-gans-for-simulating.html#0001-01-01](http://epchan.blogspot.com/2019/12/experiments-with-gans-for-simulating.html#0001-01-01)
...
The hypothesis was that the various GANs tried will be able to generate a distribution of returns which are closer to the empirical distributions of returns than ubiquitous baselines like Monte Carlo method using the [Geometric Brownian motion](https://blog.quantinsti.com/random-walk-geometric-brownian-motion/).
...
Some of the common problems I faced were either partial or complete [mode collapse](https://aiden.nibali.org/blog/2017-01-18-mode-collapse-gans/) - where the distribution either did not have a similar sharp peak as the empirical distribution ( partial ) or any noise sample input into the generator produces a limited set of output samples ( complete).        ![](img/a0bcb3713296408cea79e497d17cbc0c.png)
...
| Empirical vs GAN | 7.155841564194154 |
| GAN vs Empirical  | 10.180867728820251 |
| Empirical vs GBM  | 1.9944835997277586 |
| GBM vs Empirical  | 2.990622397328334 |
...
| Comparison | Mean and Std Dev of VAR Values ( for 95% confidence level )  | Mean and Std Dev of VAR Values ( for 99% confidence level ) |
...
| Empirical data | -0.0416606773394755 (one ground truth value)  | -0.0711425634927405 (one ground truth value)  |
