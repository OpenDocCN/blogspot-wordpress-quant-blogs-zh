...
# VIX and More: The VIX, Lehman Brothers, and Forecasting

> 来源：[http://vixandmore.blogspot.com/2008/12/vix-lehman-brothers-and-forecasting.html#0001-01-01](http://vixandmore.blogspot.com/2008/12/vix-lehman-brothers-and-forecasting.html#0001-01-01)

Jeff Kearns and Michael Tsang of Bloomberg have an article out today ([VIX Fails to Forecast S&P 500 Drop, Loses Followers](http://www.bloomberg.com/apps/news?pid=20601110&sid=a6bJKg1wZ8Vc)) in which the authors contend that largely because the VIX failed to predict the October losses in the S&P 500 index (SPX), the VIX is no longer considered to be an accurate gauge of future market activity.
 ...
 **As fellow blogger Don Fishback was [quick to point out](https://www.donfishback.com/blog/2008/12/22/bloomberg-says-vix-is-worthless/), the VIX calculation actually estimates one standard deviation of annualized 30 day volatility expectations in SPX options. That standard deviation, of course, is meant to capture 68.3% of the Gaussian or [normal distribution](http://en.wikipedia.org/wiki/Normal_distribution) of prices. In fact, the distribution of VIX prices does not follow a normal distribution, but even if it did, the movements from September 11^(th) to October 10^(th) would not be that statistically improbable.
...
Of course there are many ways in which to utilize the VIX to aid in market timing. Consider that the nature of the VIX calculation is such that the VIX acts as an unbounded [oscillator](http://vixandmore.blogspot.com/search/label/oscillators) whose values are derived from prices paid for options on the SPX. Like most oscillators, traders tend to use extreme values as opportunities to bet on a [reversion to the mean](http://vixandmore.blogspot.com/search/label/mean%20reversion).

A good deal of the difficulty in understanding the movements of the VIX is that some of the dominant patterns are different over the course of different time horizons. For instance, in the short-term, the VIX commonly spikes and mean reverts. Looking at the intermediate term, the VIX frequently establishes strong trends; and in the long term, the VIX has a tendency to move in [cycles of 2-4 years](http://vixandmore.blogspot.com/search/label/VIX%20macro%20cycles). For the month of September and most of the month of October, the VIX was in an uncharacteristically strong sustained uptrend.

Part of the reason for the sharp move in the VIX during September and October is that it is highly dependent upon macroeconomic and fundamental events that help to shape investor perceptions of uncertainty, risk and [fear](http://vixandmore.blogspot.com/search/label/fear). In the week leading up to the Lehman Brothers bankruptcy, for instance, very few investors believed that the government was prepared to let Lehman fail. Additionally, in retrospect is seems as if those who did believe failure was an option did not comprehend the nature of the systemic reverberations that a Lehman bankruptcy would trigger.
