<!--yml
category: 未分类
date: 2024-05-18 17:28:13
-->

# VIX and More: Draft Trader Development Stage Model

> 来源：[http://vixandmore.blogspot.com/2009/09/draft-trader-stage-development-model.html#0001-01-01](http://vixandmore.blogspot.com/2009/09/draft-trader-stage-development-model.html#0001-01-01)
...
So…without further ado, I have appended below the first draft of the [trader development stage model](http://vixandmore.blogspot.com/search/label/trader%20development%20stage%20model), which is hopefully relatively self-explanatory. Note that the vertical gray arrows are supposed to represent tension between related issues (leverage vs. position sizing, minimizing losers while maximizing winners, developing an edge vs. diversification.) Also, while I consider all the issues to be iterative, I suggest that the iteration process in the third stage is continuous.
