...
> 来源：[http://vixandmore.blogspot.com/2009/04/how-to-create-your-own-portable-vxv.html#0001-01-01](http://vixandmore.blogspot.com/2009/04/how-to-create-your-own-portable-vxv.html#0001-01-01)

I recently received a question from a reader who was looking to create a homemade version of the [VXV](http://vixandmore.blogspot.com/search/label/VXV) that he could apply to the Nifty (formally known as the [S&P CNX Nifty](http://www.nseindia.com/content/indices/ind_nifty.htm)), which is an index of 50 large capitalization companies on the [National Stock Exchange of India](http://www.nseindia.com/homepage.htm). Specifically, the reader wanted to know if it would be possible to use a 93 day moving average of the [India VIX](http://vixandmore.blogspot.com/search/label/India%20VIX) to create an index that would be analogous to the VXV.
...
This is not the same approach that is used by the CBOE, which is more complex and is detailed in the [CBOE S&P 500 3-Month Volatility Index Description](http://www.cboe.com/micro/vxv/3monthvix.pdf). This quick and dirty variant can be calculated quickly and is portable across any underlying with options, including the Nifty.
