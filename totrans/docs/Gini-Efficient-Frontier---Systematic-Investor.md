<!--yml
category: 未分类
date: 2024-05-18 14:41:41
-->

# Gini Efficient Frontier | Systematic Investor

> 来源：[https://systematicinvestor.wordpress.com/2012/03/24/gini-efficient-frontier/#0001-01-01](https://systematicinvestor.wordpress.com/2012/03/24/gini-efficient-frontier/#0001-01-01)

[David Varadi](http://cssanalytics.wordpress.com/) have recently wrote two posts about [Gini Coefficient](http://en.wikipedia.org/wiki/Gini_coefficient): [I Dream of Gini](http://cssanalytics.wordpress.com/2012/02/24/i-dream-of-gini/), and [Mean-Gini Optimization](http://cssanalytics.wordpress.com/2012/02/25/mean-gini-optimization/). I want to show how to use Gini risk measure to construct efficient frontier and compare it with alternative risk measures I discussed previously.

I will use [Gini mean difference](http://en.wikipedia.org/wiki/Mean_difference) risk measure – the mean of the difference between every possible pair of returns to construct Mean-Gini Efficient Frontier. I will use methods presented in “The Generation of Mean Gini Efficient Sets” by J. Okunev (1991) paper to construct optimal portfolios.
...
![\Gamma = \frac{1}{T^2}\sum_{j=1}^{T}\sum_{k>j}^{T}\left | Y_{j} - Y_{k} \right | ](img/1ac48bc2848dbee0b2375d68b559ab91.png)
...
[![](img/180be18f3265d7319b5e09430bcb68f8.png "plot1g.png.small")](https://systematicinvestor.wordpress.com/wp-content/uploads/2012/03/plot1g-small.png)
...
To view the complete source code for this example, please have a look at the [aa.gini.test() function in aa.test.r at github](https://github.com/systematicinvestor/SIT/blob/master/R/aa.test.r).

Next I added Gini risk measure to the mix of Asset Allocation strategies that I examined in the [Backtesting Asset Allocation portfolios](https://systematicinvestor.wordpress.com/2012/03/19/backtesting-asset-allocation-portfolios/) post.

[![](img/57ec3736de8f90ce9651bc2f9090e2c9.png "plot1.png.small")](https://systematicinvestor.wordpress.com/wp-content/uploads/2012/03/plot1-small4.png)

[![](img/9f988aecfd23240735b59224eeddfba8.png "plot2.png.small")](https://systematicinvestor.wordpress.com/wp-content/uploads/2012/03/plot2-small4.png)
